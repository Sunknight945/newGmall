...
public class SkuImagesController {
	 ...
	 */
	@GetMapping("imageList/{skuId}")
	public Resp<List<SkuImagesEntity>> queryImageListBySkuId(@PathVariable("skuId") Long skuId) {
		List<SkuImagesEntity> skuImagesEntityList = this.skuImagesService.queryImageListBySkuId(skuId);
		return Resp.ok(skuImagesEntityList);
	}
